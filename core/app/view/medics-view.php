...
<div class="card">
  <div class="card-header" data-background-color="blue">
      <h4 class="title">Veterinario</h4>
  </div>
  <div class="card-content table-responsive">

<div class="btn-group">
	<a href="index.php?view=newmedic" class="btn btn-default"><i class='fa fa-support'></i> Nuevo Veterinario</a>
...
<?php
			...
			echo "<p class='alert alert-danger'>No hay Veterinario</p>";
		}
